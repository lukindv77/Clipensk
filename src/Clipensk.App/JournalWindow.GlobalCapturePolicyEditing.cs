...
public sealed partial class JournalWindow
{
        ...
        ClipboardCapturePolicy currentPolicy)
    {
        ...
        {
            Text = "Изменяются базовое правило и стандартные форматы. Пользовательские двоичные форматы и расширения их файлов сохраняются без изменений. Изменение действует только на новые записи; уже сохранённая история не удаляется.",
