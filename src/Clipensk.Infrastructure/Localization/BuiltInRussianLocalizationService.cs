...
public sealed class BuiltInRussianLocalizationService : ILocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Strings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["CapturePolicy.ExternalHelp"] = "Изображения сохраняются отдельными файлами и не защищаются паролем базы данных. Пользовательские бинарные форматы будут настраиваться отдельно.",
        ["CapturePolicy.SetupHelp"] = "Это первоначальное сохранение правил. Их последующее изменение пока недоступно. Сохранение правил само по себе не включает сбор истории.",
        ...
        ["CapturePolicy.State.Saving"] = "Сохранение первоначальных правил…",
        ["CapturePolicy.State.Configured"] = "Первоначальные правила сохранены. Их изменение и сбор истории пока недоступны.",
