...
public sealed class BuiltInRussianLocalizationService : ILocalizationService
{
    private static readonly IReadOnlyDictionary<string, string> Strings = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["ApplicationPolicy.Body"] = "Выберите обнаруженное приложение, чтобы посмотреть его индивидуальное правило сбора. Базовое правило приложения можно изменить безопасным обслуживанием; форматные переопределения сохраняются без изменений.",
