...
**Реализуется (протокол `DATA_ROOT_RELOCATION_PROTOCOL.md`, решение пользователя от 2026-09-20 —
делать отдельно):** полный перенос настроек и базы при смене пути в настройках. Это не копирование папки: нужно гарантированно
