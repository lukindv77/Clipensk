...
Storage 712, Core 327, Infrastructure 142 — все зелёные локально. Ручной smoke групп, переноса
...
12. **Криптография: оставшиеся решённые пункты** (`OPEN_QUESTIONS.md` §4, решения 2026-09-23) — не
    ...
    Удаление копий `Current/CatalogQuarantine` по сроку корзины, «Начать текущую базу заново» и
    смена пароля — реализованы (§E пункты 36–38).
